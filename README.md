...
- **Система тем оформления** — встроенные 2D-темы Material You, Orbital и
  Pixel Perfect, а также 3D-тема Star Citizen (Grim HEX) с неоновыми
  3D-виджетами. 2D и 3D темы выбираются независимо и хранятся в разных
  полях настроек.
...
3D-тема Star Citizen, когда включена, перекрывает 2D-тему: весь оверлей
(2D-виджеты, сцены и Колесо) переходит на HUD Star Citizen, а 3D-виджеты
становятся видимыми. При выборе «Выкл» в группе 3D возвращается сохранённая
2D-тема. Тема влияет только на сам оверлей и его превью на канвасе — панель
