...
- **Material You** — официальная базовая фиолетовая палитра Material 3
  ...
  блюром, бейдж-пилюля у лейбла алерта (по умолчанию). 3D-вариант — **Material You 3D**.
...
кладёт её в список тем, дальше её можно снова редактировать или удалить.
У своих тем 3D-варианта нет.
