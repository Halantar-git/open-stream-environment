...
и размытие фона, цвет ошибки и анимация появления алертов (длительность и
кривая). Для продвинутых есть отдельный CSS-редактор в духе Notepad++
...
- `db` — создание коллекций, история донатов и чата, очистка, лимит истории;
