...
На вкладке «Настройки» → «Оформление» есть встроенные темы:
...
- **Star Citizen Theme Pack** — 8 тем по мотивам производителей кораблей:
  Drake Interplanetary, Aegis Dynamics, Anvil Aerospace, Origin Jumpworks,
  Roberts Space Industries (RSI), MISC, Crusader Industries и Esperia / Banu.
  У каждой своя палитра MD3, характер скруглений (от резких 2–4px у
  Drake/Aegis до мягких 16px у Origin/MISC) и фирменный акцент.
...
Покрытие (12 наборов, 53 теста):

- `db` — создание коллекций lowdb, история донатов, очистка;
