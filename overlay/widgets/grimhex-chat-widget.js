...
/*
  WidgetGrimHexChat — pirate-sci-fi stream chat for the Grim HEX theme.
...
(function (root, factory) {
  ...
  const WidgetGrimHexChat = factory(BaseWidget);

  if (typeof module !== "undefined" && module.exports) {
    module.exports = WidgetGrimHexChat;
  } else {
    root.OSEWidgets = root.OSEWidgets || {};
    root.OSEWidgets.WidgetGrimHexChat = WidgetGrimHexChat;
  }
  ...
  class WidgetGrimHexChat extends BaseWidget {
    ...
    onMount() {
      ...
      this.element.classList.add("grimhex-chat-surface");
      this._applySurface();
      ...
      this.messagesScroller.className = "grimhex-chat__viewport";
      ...
      this.messagesInner.className = "grimhex-chat__list";
    ...
    pushMessage(msg) {
      ...
      row.className = "grimhex-chat__row";
      row.style.cssText =
