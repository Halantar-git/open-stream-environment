...
describe("WidgetEliteSign", () => {
  ...
  test("выключатель движения: эмблема стоит на месте, неон продолжает играть", () => {
    const parent = makeEl("div");
    const still = new WidgetEliteSign(
      { ...eliteSignItem(), renderType: "canvas", config: { motion: false } },
