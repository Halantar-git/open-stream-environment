...
(function (root) {
  ...
  const ICONS = {
    ...
    widgetStarCitizenRadar: `<svg viewBox="0 0 24 24" ${stroke}><ellipse cx="12" cy="12" rx="9" ry="4.5"/><ellipse cx="12" cy="12" rx="5" ry="2.5"/><path d="M12 3v18M3 12h18"/><path d="M12 9.5l1.6 2.5-1.6-2.5z"/></svg>`,
