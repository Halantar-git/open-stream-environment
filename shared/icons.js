...
(function (root) {
  ...
  const ICONS = {
    ...
    widgetGrimHexChat: `<svg viewBox="0 0 24 24" ${stroke}><path d="M4 5h16v11H8l-4 4V5z"/><path d="M8 9h8M8 12h5"/></svg>`,
    widgetGrimHexGoal: `<svg viewBox="0 0 24 24" ${stroke}><circle cx="6" cy="12" r="3.2"/><circle cx="12" cy="12" r="3.2"/><circle cx="18" cy="12" r="3.2"/></svg>`,
    widgetGrimHexHoloAlert: `<svg viewBox="0 0 24 24" ${stroke}><circle cx="12" cy="9" r="5"/><path d="M9 13l-2 8 5-3 5 3-2-8"/></svg>`,
    widgetGrimHexRadar: `<svg viewBox="0 0 24 24" ${stroke}><ellipse cx="12" cy="12" rx="9" ry="4.5"/><ellipse cx="12" cy="12" rx="5" ry="2.5"/><path d="M12 3v18M3 12h18"/><path d="M12 9.5l1.6 2.5-1.6-2.5z"/></svg>`,
    widgetNuclear: `<svg viewBox="0 0 24 24" ${stroke}><circle cx="12" cy="12" r="8.4"/><circle cx="12" cy="12" r="2.1" fill="currentColor" stroke="none"/><path d="M12 12 L7.8 4.73 A8.4 8.4 0 0 1 16.2 4.73 Z" fill="currentColor" stroke="none"/><path d="M12 12 L7.8 4.73 A8.4 8.4 0 0 1 16.2 4.73 Z" fill="currentColor" stroke="none" transform="rotate(120 12 12)"/><path d="M12 12 L7.8 4.73 A8.4 8.4 0 0 1 16.2 4.73 Z" fill="currentColor" stroke="none" transform="rotate(240 12 12)"/></svg>`,
    widgetNuclearChat: `<svg viewBox="0 0 24 24" ${stroke}><path d="M4 5h16v11H8l-4 4V5z"/><circle cx="12" cy="10.5" r="1.6" fill="currentColor" stroke="none"/><path d="M12 10.5l-1.3-3M12 10.5l1.3-3M12 10.5l0-3"/></svg>`,
    widgetNuclearGoal: `<svg viewBox="0 0 24 24" ${stroke}><rect x="4" y="13" width="3" height="7" rx="1"/><rect x="8.5" y="11" width="3" height="9" rx="1"/><rect x="13" y="9" width="3" height="11" rx="1"/><rect x="17.5" y="11" width="3" height="9" rx="1"/></svg>`,
    ...
    widgetCobraShield: `<svg viewBox="0 0 24 24" ${stroke}><circle cx="12" cy="12" r="8.5"/><path d="M12 6l1.6 4.2 4.4.7-3.2 3 .7 4.1-3.5-2-3.5 2 .7-4.1-3.2-3 4.4-.7L12 6z"/></svg>`,
    widgetCobraRadar: `<svg viewBox="0 0 24 24" ${stroke}><ellipse cx="12" cy="12" rx="9" ry="4.5"/><ellipse cx="12" cy="12" rx="6" ry="3"/><ellipse cx="12" cy="12" rx="3" ry="1.5"/><path d="M12 3v18M3 12h18"/><path d="M12 9.5l1.6 2.5-1.6-2.5z"/></svg>`,
    widgetMd3Orb: `<svg viewBox="0 0 24 24" ${stroke}><circle cx="12" cy="12" r="7.5"/><ellipse cx="12" cy="12" rx="7.5" ry="3.4"/><path d="M12 5a7 7 0 0 1 0 14" opacity="0.6"/></svg>`,
    widgetMd3Chat: `<svg viewBox="0 0 24 24" ${stroke}><rect x="3" y="5" width="18" height="14" rx="4"/><path d="M8 10h8M8 13.5h5"/></svg>`,
    widgetMd3Goal: `<svg viewBox="0 0 24 24" ${stroke}><rect x="4" y="10" width="16" height="5" rx="2.5"/><path d="M7 12.5h7" stroke-width="3"/></svg>`,
    widgetMd3HoloAlert: `<svg viewBox="0 0 24 24" ${stroke}><circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3" fill="currentColor" stroke="none"/><path d="M12 4v2.2M12 17.8V20M4 12h2.2M17.8 12H20" opacity="0.7"/></svg>`,
    widgetPixelCube: `<svg viewBox="0 0 24 24" ${stroke}><path d="M12 2l8 4.5v9L12 20l-8-4.5v-9L12 2z"/><path d="M4 6.5L12 11l8-4.5M12 11v9"/></svg>`,
    widgetPixelChat: `<svg viewBox="0 0 24 24" ${stroke}><rect x="3" y="5" width="18" height="13"/><path d="M8 9h8M8 12h5"/><path d="M3 5l3-1M21 5l-3-1"/></svg>`,
    ...
    bug: `<svg viewBox="0 0 24 24" ${stroke}><path d="M9 3h6M10 3v5.5L5.5 17a2 2 0 0 0 1.8 3h9.4a2 2 0 0 0 1.8-3L14 8.5V3"/><path d="M7.5 14h9"/></svg>`,
